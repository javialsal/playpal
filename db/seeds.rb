...
50.times do
  ...
  description = ["A real part of Tarot to find your real level", "It's just a description because we have to add a description and it's boring", "On risque de se faire bouger par les flics mais c'est le nouvel an alors on s'en fout on n'a qu'une vie", "Le tarot c'est la vie", "Grosse partie, le gagnant paye sa tournée!", "Ne pas s'inscrire pour autre chose que du jeu", "Du jeu, du beau jeu, et de la stratégie à gogo" ].sample
